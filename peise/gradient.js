        ...
        <div class="contrast-panel">
            ...
            <div class="contrast-row">
                <div class="contrast-card">
                    ...
                    <div>
                        <span class="contrast-tag ${
                          wLevel.aa ? "tag-pass" : "tag-fail"
                        }">AA ${wLevel.aa ? "合规" : "不通过"}</span>
                        <span class="contrast-tag ${
                          wLevel.aaa ? "tag-pass" : "tag-warn"
                ...
                <div class="contrast-card">
                    ...
                    <div>
                        <span class="contrast-tag ${
                          bLevel.aa ? "tag-pass" : "tag-fail"
                        }">AA ${bLevel.aa ? "合规" : "不通过"}</span>
                        <span class="contrast-tag ${
                          bLevel.aaa ? "tag-pass" : "tag-warn"
  ...
  if (formatSelect) {
    formatSelect.onchange = (e) => {
      ...
      if (valueSpan && newFormat === "css") {
        ...
        valueSpan.innerHTML = `<span style="color: var(--accent);">--color-${colorSlug}</span>: ${
          currentHoverColor || baseHex
        };`;
      } else if (valueSpan) {
