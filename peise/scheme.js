...
import { schemeConfigs } from "https://cdn.jsdelivr.net/gh/wjzcd2011/yuxiaoxiong/img2/constants.js";
import {
  getColorById,
  addColor,
  getActiveGroupId,
...
import { getColorName } from "https://cdn.jsdelivr.net/gh/wjzcd2011/yuxiaoxiong/img2/colorNames.js";
import { addToHistory } from "https://cdn.jsdelivr.net/gh/wjzcd2011/yuxiaoxiong/img2/history.js";
...
export function renderSchemePanel(
  ...
  for (const [key, cfg] of Object.entries(schemeConfigs)) {
    tabsHtml += `<button class="scheme-tab ${
  ...
  wrap.innerHTML = `
        <div class="scheme-base-indicator">
            <div class="scheme-base-swatch" style="background:${
              curr.hex
            }"></div>
            <div class="scheme-base-text">基于主色：<span class="scheme-base-name">${
              curr.name || "未命名"
            } ${curr.hex}</span></div>
        </div>
        ${tabsHtml}
