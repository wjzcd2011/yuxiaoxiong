// 存储工具
import { STORAGE_KEY, THEME_STORAGE_KEY, HISTORY_STORAGE_KEY } from '../constants.js';

export function saveToStorage(groups, colors, nextColorId, nextGroupId, activeGroupId, currentFormat, selectedColorId) {
    try {
        localStorage.setItem(STORAGE_KEY, JSON.stringify({
            groups, colors, nextColorId, nextGroupId,
            activeGroupId, currentFormat, selectedColorId
        }));
    } catch (e) {
