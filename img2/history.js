// 颜色历史记录管理
import { MAX_HISTORY_SIZE, HISTORY_STORAGE_KEY } from "../constants.js";
...
import { addColor, getActiveGroupId, getColors } from "./colors.js";
  ...
  return `
    ...
    name
      ...
      <div class="history-actions">
        <button class="history-pin ${item.pinned ? "pinned" : ""}" title="${
    item.pinned ? "取消固定" : "固定"
  }">
