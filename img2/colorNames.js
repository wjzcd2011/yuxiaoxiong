// 颜色名称数据
import { BUILTIN_COLOR_NAMES } from "https://cdn.jsdelivr.net/gh/wjzcd2011/yuxiaoxiong/img2/constants.js";
import { colorDifference } from "https://cdn.jsdelivr.net/gh/wjzcd2011/yuxiaoxiong/img2/colorUtils.js";
...
export async function loadColorNames() {
  try {
    const resp = await fetch(
      "https://cdn.jsdelivr.net/gh/wjzcd2011/yuxiaoxiong/img2/colorName.json"
    );
    if (resp.ok) {
