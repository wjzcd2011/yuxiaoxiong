...
export function initCvdSimulation() {
    ...
    function setCvdFilter(value) {
        ...
        document.querySelectorAll('.shade-swatch, .scheme-swatch-color, .color-preview')
        ...
        const selectedText = Array.from(cvdButtons).find(btn => btn.getAttribute('data-cvd') === value)?.innerText || '正常视觉';
    ...
    if (savedCvd && ['none', 'protanopia', 'deuteranopia', 'tritanopia'].includes(savedCvd)) {
