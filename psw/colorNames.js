// 颜色名称数据
import { BUILTIN_COLOR_NAMES } from "https://cdn.jsdelivr.net/gh/wjzcd2011/yuxiaoxiong/psw/constants.js";
import { colorDifference } from "https://cdn.jsdelivr.net/gh/wjzcd2011/yuxiaoxiong/psw/colorUtils.js";
...
export async function loadColorNames() {
  try {
    const resp = await fetch(
      "https://cdn.jsdelivr.net/gh/wjzcd2011/yuxiaoxiong/psw/colorName.json"
    );
    if (resp.ok) {
