...
import {
  ...
  getBrightness,
  formatColorByType,
} from "https://cdn.jsdelivr.net/gh/wjzcd2011/yuxiaoxiong/peisewang/colorUtils.js";
import {
  showToast,
  copyText,
} from "https://cdn.jsdelivr.net/gh/wjzcd2011/yuxiaoxiong/peisewang/domUtils.js";
import {
  loadFromStorage,
  saveToStorage,
...
import {
  ...
  getColorName,
  setColorNames,
} from "https://cdn.jsdelivr.net/gh/wjzcd2011/yuxiaoxiong/peisewang/colorNames.js";
import {
  getGroups,
  setGroups,
  getNextGroupId,
  ...
  addGroup,
  renderGroups,
} from "https://cdn.jsdelivr.net/gh/wjzcd2011/yuxiaoxiong/peisewang/groups.js";
import {
  getColors,
  setColors,
  getNextColorId,
...
import {
  ...
  getHistoryColors,
  setHistoryColors,
} from "https://cdn.jsdelivr.net/gh/wjzcd2011/yuxiaoxiong/peisewang/history.js";
import {
  renderGradientPanel,
  cleanupGradientResize,
} from "https://cdn.jsdelivr.net/gh/wjzcd2011/yuxiaoxiong/peisewang/gradient.js";
import {
  renderSchemePanel,
  setActiveSchemeTab,
} from "https://cdn.jsdelivr.net/gh/wjzcd2011/yuxiaoxiong/peisewang/scheme.js";
import {
  initColorWorker,
  ...
  closeImagePickModal,
  resetExtractedData,
} from "https://cdn.jsdelivr.net/gh/wjzcd2011/yuxiaoxiong/peisewang/imageExtract.js";
import {
  exportData,
  showImportModeModal,
  setImportMode,
...
} from "https://cdn.jsdelivr.net/gh/wjzcd2011/yuxiaoxiong/peisewang/exportImport.js";
import { initEyeDropper } from "https://cdn.jsdelivr.net/gh/wjzcd2011/yuxiaoxiong/peisewang/eyeDropper.js";
import { initDragAndDrop } from "https://cdn.jsdelivr.net/gh/wjzcd2011/yuxiaoxiong/peisewang/dragDrop.js";
import {
  confirmOperate,
  openColorModal,
  closeColorModal,
  ...
  closeAllModals,
  getConfirmCallback,
} from "https://cdn.jsdelivr.net/gh/wjzcd2011/yuxiaoxiong/peisewang/modal.js";
import { initKeyboardShortcuts } from "https://cdn.jsdelivr.net/gh/wjzcd2011/yuxiaoxiong/peisewang/shortcuts.js";
import { initTheme } from "https://cdn.jsdelivr.net/gh/wjzcd2011/yuxiaoxiong/peisewang/theme.js";
import { initCvdSimulation } from "https://cdn.jsdelivr.net/gh/wjzcd2011/yuxiaoxiong/peisewang/cvdSimulation.js";
import {
  initPlayer,
  updatePlayerHighlightClass,
} from "https://cdn.jsdelivr.net/gh/wjzcd2011/yuxiaoxiong/peisewang/player.js";
...
export function renderAll() {
  ...
  handleColorClick = (colorId) => {
    if (getIsMultiSelectMode()) {
      ...
      showToast(
        `✨ 已选中「${colorInfo.n || clickedColor.name
        }」，可在下方查看配色方案`,
        2500
      );
    }
