...
function show_loading_bar(options) {
    var defaults = { pct: 0, delay: 1.3, wait: 0, before: function() {}, finish: function() {}, resetOnEnd: true };
    ...
    TweenMax.to($pct, defaults.delay, {
        ...
        onStart: function() { $loading_bar.removeClass("progress-is-hidden") },
        onComplete: function() {
            var pct = $pct.data("pct");
            if (pct == 100 && defaults.resetOnEnd) { hide_loading_bar() }
            defaults.finish(pct)
        },
